...
public class SerializationCompareTest
{
	...
	public void testCompactedJavaOutputPerm() throws Exception {
		...
		System.out.println("compacted java write and parse 500 times in " + (System.currentTimeMillis() - now) + "ms, size "
				+ len);
	}
	...
	public void testBuilderPerm1() throws Exception {
		...
		len = os.toByteArray().length;
		System.out.println("[reportprint]Builder write 1 times in " + (System.currentTimeMillis() - now) + "ms, size " + len);
		...
		System.out.println("[reportprint]Builder  parse 1 times in " + (System.currentTimeMillis() - now) + "ms, size " + len);
	}
	...
	public void testH2oPerm1() throws Exception {
		...
		os.close();
		System.out.println("[reportprint]Hessian2 write 1 times in " + (System.currentTimeMillis() - now) + "ms, size " + len);
		now = System.currentTimeMillis();
		ByteArrayInputStream is = new ByteArrayInputStream(os.toByteArray());
		Hessian2Input in = new Hessian2Input(is);
		assertEquals(in.readObject().getClass(), ReportPrint.class);

		System.out.println("[reportprint]Hessian2  parse 1 times in " + (System.currentTimeMillis() - now) + "ms, size " + len);
	}
	...
	public void testJavaOutputPerm1() throws Exception {
		...
		int len = os.toByteArray().length;
		os.close();
		System.out.println("[reportprint]java write 1 times in " + (System.currentTimeMillis() - now) + "ms, size " + len);
		now = System.currentTimeMillis();
		ByteArrayInputStream is = new ByteArrayInputStream(os.toByteArray());
		ObjectInputStream in = new ObjectInputStream(is);
		assertEquals(in.readObject().getClass(), ReportPrint.class);
		System.out.println("[reportprint]java  parse 1 times in " + (System.currentTimeMillis() - now) + "ms, size " + len);
	}
	...
	public void testCompactedJavaOutputPerm1() throws Exception {
		...
		int len = os.toByteArray().length;
		os.close();
		System.out.println("[reportprint]compacted write 1 times in " + (System.currentTimeMillis() - now) + "ms, size " + len);
		now = System.currentTimeMillis();
		ByteArrayInputStream is = new ByteArrayInputStream(os.toByteArray());
		CompactedObjectInputStream in = new CompactedObjectInputStream(is);
		assertEquals(in.readObject().getClass(), ReportPrint.class);

		System.out.println("[reportprint]compacted  write and parse 1 times in " + (System.currentTimeMillis() - now)
				+ "ms, size " + len);
	}
